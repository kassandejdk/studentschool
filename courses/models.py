...
class Course(models.Model):
    ...
    note_choix = models.IntegerField(default=0)
    note_question = models.IntegerField(default=0)
    niveau = models.CharField(max_length=8,default="")
...
class Video(models.Model):
    video = models.FileField(null=False, blank=False, default='')
